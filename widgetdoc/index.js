...
module.exports = new Package('widgetdoc', [require('../jsdoc'), require('../nunjucks')])

.factory(require('./file-readers/widgetdoc'))
...
.processor(require('./processors/filterWidgetdocs'))
...
.config(function(readFilesProcessor, widgetdocFileReader) {
  readFilesProcessor.fileReaders.push(widgetdocFileReader);
})
